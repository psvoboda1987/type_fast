...
function WordGame() {
  return {
    ...
    allowedKeyCodes: [
      ...
      // enter, dash, minus, backspace, shift, F5, Ctrl  keycode
      13, 189, 109, 8, 16, 116, 17
    ],
    ...
    initDifficultySettings: function () {
    ...
    initKeys: function () {
      document.addEventListener('keydown', (event) => {
        if (this.isInvalidKey(event)) event.preventDefault()
    ...
    isInvalidKey: function (event) {
      return this.allowedKeyCodes.indexOf(event.keyCode) === -1
    },
    ...
    setDifficulty: function (setting = 'easy') {
    ...
    reset: function () {
      if (this.game.className === '') this.setDifficulty()
